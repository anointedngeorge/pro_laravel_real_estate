        ...
        <AuthenticatedLayout
            ...
            header={
                <div className='flex justify-between'>
                    ...
                    <Link className='px-2 py-2 rounded items-center hover:bg-green-600 bg-green-500 text-white' href={route('propertysales.create')}>Add Propertysales</Link>
                </div>
            }
        >
                            ...
                            <div className='overflow-auto'>
                                ...
                                >
                                    ...
                                    <tbody className='odd:bg-white even:bg-gray-50'>
                                        {pageData.propertysales.data.map((propertysales, index) => (
                                            <tr key={propertysales.id}>
                                                <TableRow>{index + 1}</TableRow>
                                                <TableRow>{propertysales.fullname}</TableRow>
                                                <TableRow>{propertysales.phone}</TableRow>
                                                <TableRow>
                                                    <ul className='text-nowrap flex gap-x-2 px-2 py-3'>
                                                        <li>
                                                            <Link className='text-blue-500' href={route('propertysales.edit', propertysales.id)}>Edit</Link>
                                                        </li>
                                                        <li>
                                                            <Link className='text-amber-500' href={route('propertysales.show', propertysales.id)}>View</Link>
                                                        </li>
                                                        <li>
                                                            <button className='text-red-500' onClick={e => onDestroy(propertysales)}>Delete</button>
                                                        </li>
                                                    </ul>
                                                </TableRow>
                                            </tr>
